...
# Registrar una comida con sus macronutrientes
def registrarComida(nombre):
    ...
    comida = [nombre, porcion, prote, carb, gras]
    return comida


# Mostrar todas las comidas guardadas
...
# Calcular el total de macros del día
...
# Calcular el promedio de macros
...
# Evaluar si el usuario cumple con sus objetivos
...
# Función de pruebas para validar el funcionamiento
def pruebas():
    comidas = [
        ["Pollo", "100g", 25, 0, 3],
        ["Arroz", "1 taza", 5, 45, 1],
